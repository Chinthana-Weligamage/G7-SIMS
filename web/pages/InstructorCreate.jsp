                        ...
                        <div class="col-lg-7">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Add New Instructor</h1>
                                </div>
                                <form action="Instructors" method="post" class="user">
                                    <input type="hidden" name="action" value="insert" readonly>
                                    ...
                                    <input type="submit" value="Add Instructor" class="btn btn-primary btn-user btn-block">
                                    <hr>
                                    <div class="text-center">
