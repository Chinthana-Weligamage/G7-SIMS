                        ...
                        <div class="col-lg-7">
                            <div class="p-5">
                                ...
                                <form action="Courses" method="post" class="user">
                                    ...
                                    <input type="hidden" name="id" value="${course.courseId}" readonly>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="courseName"
                                               placeholder="Course Name" value="${course.courseName}" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="courseDescription"
                                               placeholder="Description" value="${course.courseDescription}" required>
                                    </div>
